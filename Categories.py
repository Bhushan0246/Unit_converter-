...
class Frame_units:
    def __init__(self, root):
        ...
        self.back = CTkButton(root,text='', fg_color=color_bg, border_spacing=3, corner_radius=50, image=conv_img_back,
                         height=30, width=32, border_width=2, border_color='#88dd88', command=self.backmain)
        ...
        self.len = CTkButton(root, text='Length', fg_color = color_bg, font=font2, text_color= '#DD8487', border_spacing=3, corner_radius=10,
                             height=30, width=120, hover_color='#169c95', command=self.length)
        ...
        self.temp = CTkButton(root, text='Temperature', fg_color = color_bg, font=font2, text_color= '#DD8487', border_spacing=3, corner_radius=10, height=30, width=120)
